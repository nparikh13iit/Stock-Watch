...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    void addStock(Stock temp)
    {
        ...
        Log.d(TAG, "addStock: bp: Adding Stock: "+ temp.getSymbol() + " | " + temp.getName());
        values.put(SYMBOL, temp.getSymbol());
        values.put(NAME, temp.getName());
        long key = db.insert(TABLE_NAME, null, values);
        Log.d(TAG, "addStock: bp: Added Stock: "+ temp.getSymbol() + " | " + temp.getName());
    }

    void deleteStock(Stock temp)
    {
        Log.d(TAG, "deleteStock: bp: Deleting Stock: " + temp.getSymbol()+ " | " + temp.getName());
        int cnt = db.delete(TABLE_NAME, SYMBOL + " = ?", new String[]{temp.getSymbol()});
        Log.d(TAG, "deleteStock: bp: Deleted Stock: " + temp.getSymbol()+ " | " + temp.getName());
    }
